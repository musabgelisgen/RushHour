...
public class Level4 extends Levels {
	...
	public void createCars(ArrayList<Car> list){
		...
		car5.setTexture(new Texture("mercedes.png"));
		...
		car8.setTexture(new Texture("car10.png"));
		car8.setPosition(VIEW_WIDTH/2-w/2+car8.x*w/m, VIEW_HEIGHT/2-h/2+h*car8.y/n);
	
		car9.setTexture(new Texture("ambulance.png"));
		...
		car11.setTexture(new Texture("car10.png"));
		car11.setPosition(VIEW_WIDTH/2-w/2+car11.x*w/m, VIEW_HEIGHT/2-h/2+h*car11.y/n);
