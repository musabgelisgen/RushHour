...
public class Level4 extends Levels {
	...
	public void createCars(ArrayList<Car> list){
		...
		car9.setPosition(VIEW_WIDTH/2-w/2+car9.x*w/number_of_width_tiles, VIEW_HEIGHT/2-h/2+h*car9.y/number_of_height_tiles);
				
		car10.setTexture(new Texture("obs_car_vert.png"));
		car10.setPosition(VIEW_WIDTH/2-w/2+car10.x*w/number_of_width_tiles, VIEW_HEIGHT/2-h/2+h*car10.y/number_of_height_tiles);
		
		car11.setTexture(new Texture("obs_car_vert.png"));
		car11.setPosition(VIEW_WIDTH/2-w/2+car11.x*w/number_of_width_tiles, VIEW_HEIGHT/2-h/2+h*car11.y/number_of_height_tiles);
