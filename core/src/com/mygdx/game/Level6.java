...
public class Level6 extends Levels {
	...
	public void createCars(ArrayList<Car> list){
		Car car1=new Car(0,0,5,2,1,0);
		Car car2=new Car(1,1,2,1,2,0);
		Car car3=new Car(0,0,0,3,1,0);
		Car car4=new Car(1,2,2,1,3,0);
		Car car5=new Car(0,3,3,2,1,1);
		Car car6=new Car(0,3,2,2,1,0);
		Car car7=new Car(1,3,0,1,2,0);
